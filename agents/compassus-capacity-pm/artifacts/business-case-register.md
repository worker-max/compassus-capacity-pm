...
> with a band; the $260M relabelled as Medicare fee-for-service rather than episodic; and the
...
and labels it MODELLED and ILLUSTRATIVE. Unwound, the revenue figure cancels out entirely and
...
on the cost side of the waterfall. and it
...
cost only for whole-programme questions. The defensible lever is timing and distribution, not volume: the front-loading
