...
| **Assignment accept / decline + reason** | Scheduling | The Alabama lesson; DE-09 "the tool recommends, the human accepts" | The buy-in mechanism and the training signal for every later optimisation |
