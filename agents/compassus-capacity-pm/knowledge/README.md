...
| [`workbook-2026-08-13.md`](./workbook-2026-08-13.md) | Read-only index to the workbook — the fourteen tabs, the scoring semantics, and the variable list as of 8.13 (76 numbered + 3 unnumbered). |
| [`variable-inventory-update-2026-08-19.md`](./variable-inventory-update-2026-08-19.md) | **What changed on 19 Aug** — the inventory now holds **87 numbered variables**, all visible to scoring, all assigned to a target module. Read this before touching the `Variable Inventory` tab: it is the authority on which IDs are taken and which are reserved. |
