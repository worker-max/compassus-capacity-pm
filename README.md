...
| [`agents/compassus-capacity-pm/vendor-selection/`](./agents/compassus-capacity-pm/vendor-selection/) | **The vendor evaluation record** — the v3.0 scorecard model, dossiers on all eleven scored returns, the round-two question architecture, and the rubric review. Start at its [README](./agents/compassus-capacity-pm/vendor-selection/README.md). |
